...
![RDS Database Deletion Confirmation](/images/5.7_1.png)
![RDS Database Deleting Status](/images/5.7_2.png)
...
2. For each bucket (`novatech-product-images` and `novatech-chatbot-rag`):
   ...
   - Type `permanently delete` to acknowledge emptying objects.
     ...
     ![Confirm Emptying S3 Bucket](/images/5.7_3.png)
     ![S3 Bucket Emptied Successfully](/images/5.7_4.png)

   - Return to the Buckets list, select the bucket, and click **Delete**.
   - Enter the name of the bucket to confirm permanent deletion.

     ![Confirm S3 Bucket Deletion](/images/5.7_5.png)
     ![S3 Bucket Deleted Successfully](/images/5.7_6.png)
